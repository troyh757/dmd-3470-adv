 ...
 */ !(function (e, t) {
  ...
  !(function () {
        ...
        if (11 !== $ && (u = V.exec(e))) {
          if ((i = u[1])) {
            if (9 === $) {
              ...
              return (v.call(n, s), n);
          } else if (u[2]) return (v.apply(n, t.getElementsByTagName(e)), n);
          else if ((i = u[3]) && t.getElementsByClassName)
            return (v.apply(n, t.getElementsByClassName(i)), n);
        }
        if (!D[e + " "] && (!h || !h.test(e))) {
          if (((f = e), (g = t), 1 === $ && (R.test(e) || I.test(e)))) {
            for (
        ...
        en(function (o, s, u, l) {
          var c,
            ...
            $ =
              o ||
              (function e(t, n, r) {
                for (var i = 0, o = n.length; i < o; i++) ee(t, n[i], r);
                return r;
              })(t || "*", u.nodeType ? [u] : u, []),
            m = e && (o || !t) ? eg($, h, e, u, l) : $;
          if (
            (n
              ? ((d = i || (o ? e : y || r) ? [] : s), n(m, d, u, l))
              : (d = m),
            r)
          )
    ...
    function e$(e, t) {
      var n,
        ...
        h = T[e + " "];
      if (!h) {
        for (t || (t = ef(e)), c = t.length; c--; )
          (h = ey(t[c]))[y] ? f.push(h) : d.push(h);
        (h = T(
          e,
          ((n = d),
          (s = (i = f).length > 0),
          (a = n.length > 0),
          (u = function (e, t, u, c, f) {
            var d,
              h,
              g,
              y = 0,
            ...
            for (
              ...
              if (a && d) {
                for (
                  h = 0, t || d.ownerDocument == l || (el(d), (u = !p));
                  (g = n[h++]);
                )
                  if (g(d, t || l, u)) {
                    v.call(c, d);
            ...
            if (((y += m), s && m !== y)) {
              for (h = 0; (g = i[h++]); ) g(x, b, t, u);
              if (e) {
                if (y > 0) for (; m--; ) x[m] || b[m] || (b[m] = C.call(c));
                b = eg(b);
              }
              (v.apply(c, b),
                f && !e && b.length > 0 && y + i.length > 1 && _.uniqueSort(c));
            }
            return (f && (($ = k), (o = T)), x);
          }),
          s ? en(u) : u),
  ...
  ((_.filter = function (e, t, n) {
    ...
    _.fn.extend({
      find: function (e) {
        ...
        for (t = 0, n = this.pushStack([]); t < r; t++) _.find(e, i[t], n);
    ...
    _.extend({
      ...
      ready: function (e) {
        if (!(!0 === e ? --_.readyWait : _.isReady))
          ((_.isReady = !0),
            !(!0 !== e && --_.readyWait > 0) && Y.resolveWith(v, [_]));
      },
    }),
    (_.ready.then = Y.then),
  ...
  function em(e, t) {
    for (var n, r, i = [], o = 0, s = e.length; o < s; o++)
      (r = e[o]).style &&
        ...
        t
          ? ("none" !== n ||
              ((i[o] = ei.get(r, "display") || null),
              i[o] || (r.style.display = "")),
            "" === r.style.display && eg(r) && (i[o] = e$(r)))
          : "none" !== n && ((i[o] = "none"), ei.set(r, "display", n)));
  ...
  ((ex = v.createDocumentFragment().appendChild(v.createElement("div"))),
    (eb = v.createElement("input")).setAttribute("type", "radio"),
    eb.setAttribute("checked", "checked"),
    eb.setAttribute("name", "t"),
    ex.appendChild(eb),
    (d.checkClone = ex.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (ex.innerHTML = "<textarea>x</textarea>"),
    (d.noCloneChecked = !!ex.cloneNode(!0).lastChild.defaultValue),
    (ex.innerHTML = "<option></option>"),
    (d.option = !!ex.lastChild));
  var eC = {
    thead: [1, "<table>", "</table>"],
  ...
  function eE(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); ) {
      ...
      if (((l = ed(o)), (s = ek(f.appendChild(o), "script")), l && eS(s), n))
        for (c = 0; (o = s[c++]); ) ew.test(o.type || "") && n.push(o);
    }
    return f;
  }
  var eD = /^([^.]*)(?:\.(.+)|)/;
  ...
  function eL(e, t, n) {
    if (!n) {
      void 0 === ei.get(e, t) && _.event.add(e, t, eA);
      return;
    }
    (ei.set(e, t, !1),
      _.event.add(e, t, {
        ...
        handler: function (e) {
          ...
          if (1 & e.isTrigger && this[t]) {
            ...
            r &&
              ...
              e.stopPropagation(),
              (e.isImmediatePropagationStopped = eA));
        },
      }));
  }
  ((_.event = {
      ...
      if (v && (u = v.events)) {
        for (l = (t = (t || "").match(z) || [""]).length; l--; ) {
          if (
            ...
            for (d in u) _.event.remove(e, d + t[l], n, r, !0);
            continue;
          }
          for (
            f = _.event.special[d] || {},
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            e_.test(t.type) && t.click && w(t, "input") && eL(t, "click", !0),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            e_.test(t.type) && t.click && w(t, "input") && eL(t, "click"),
            !0
          );
        },
        _default: function (e) {
    ...
    _.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
      ...
      ((_.event.special[e] = {
        setup: function () {
          var r;
          if ((eL(this, e, !0), !v.documentMode)) return !1;
    ...
    _.fn.extend({
      on: function (e, t, n, r) {
        return eq(this, e, t, n, r);
      },
      one: function (e, t, n, r) {
        return eq(this, e, t, n, r, 1);
      },
      off: function (e, t, n) {
        var r, i;
  ...
  function eI(e, t) {
    var n, r, i, o, s, a, u;
    if (1 === t.nodeType) {
      if (ei.hasData(e) && (u = (o = ei.get(e)).events))
        for (i in (ei.remove(t, "handle events"), u))
          for (n = 0, r = u[i].length; n < r; n++) _.event.add(t, i, u[i][n]);
      eo.hasData(e) &&
        ((s = eo.access(e)), (a = _.extend({}, s)), eo.set(t, a));
    }
  }
  function eR(e, t) {
  ...
  function e9(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      y = h(v);
    if (y || (p > 1 && "string" == typeof v && !d.checkClone && eP.test(v)))
      return e.each(function (i) {
        var o = e.eq(i);
        (y && (t[0] = v.call(this, i, o.html())), e9(o, t, n, r));
      });
    if (
      p &&
      ...
      for (u = (a = _.map(ek(i, "script"), e0)).length; f < p; f++)
        ((l = i),
          f !== g &&
            ((l = _.clone(l, !0, !0)), u && _.merge(a, ek(l, "script"))),
          n.call(e[f], l, f));
      if (u)
        for (c = a[a.length - 1].ownerDocument, _.map(a, eW), f = 0; f < u; f++)
          ((l = a[f]),
            ew.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : $(l.textContent.replace(eO, ""), l, c)));
    }
    return e;
  }
  function eF(e, t, n) {
    for (var r, i = t ? _.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      (n || 1 !== r.nodeType || _.cleanData(ek(r)),
        r.parentNode &&
          (n && ed(r) && eS(ek(r, "script")), r.parentNode.removeChild(r)));
    return e;
  }
  (_.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = 0, s = ek(a), i = (o = ek(e)).length; r < i; r++)
          eR(o[r], s[r]);
      if (t) {
        if (n)
          for (r = 0, o = o || ek(e), s = s || ek(a), i = o.length; r < i; r++)
            eI(o[r], s[r]);
        else eI(e, a);
      }
      return (
        (s = ek(a, "script")).length > 0 && eS(s, !u && ek(e, "script")),
        a
      );
    },
    ...
    _.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (_.cleanData(ek(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  ((t = this[n] || {}),
                    1 === t.nodeType &&
                      (_.cleanData(ek(t, !1)), (t.innerHTML = e)));
                t = 0;
              } catch (i) {}
            }
      ...
      replaceWith: function () {
        ...
        return e9(
          ...
          function (t) {
            ...
            0 > _.inArray(this, e) &&
              (_.cleanData(ek(this)), n && n.replaceChild(t, this));
          },
          e,
        );
      },
  ...
  var eV = ["Webkit", "Moz", "ms"],
    e3 = v.createElement("div").style,
    e7 = {};
  function e4(e) {
    var t = _.cssProps[e] || e7[e];
    return (
      t ||
      (e in e3
        ? e
        : (e7[e] =
            (function e(t) {
              for (
                var n = t[0].toUpperCase() + t.slice(1), r = eV.length;
                r--;
              )
                if ((t = eV[r] + n) in e3) return t;
            })(e) || e))
    );
  }
  ...
  function e5(e, t, n) {
    ...
    return (
      ((!d.boxSizingReliable() && i) ||
        ...
        (o = a in e) && (s = e[a])),
      (s = parseFloat(s) || 0) +
        eK(e, t, n || (i ? "border" : "content"), o, r, s) +
        "px"
    );
  }
  function eJ(e, t, n, r, i) {
    return new eJ.prototype.init(e, t, n, r, i);
  }
  (_.extend({
    cssHooks: {
      opacity: {
    ...
    css: function (e, t, n, r) {
      var i,
        ...
        s,
        a = et(t);
      return (eB.test(t) || (t = e4(a)),
      (s = _.cssHooks[t] || _.cssHooks[a]) &&
        "get" in s &&
        (i = s.get(e, !0, n)),
      void 0 === i && (i = e2(e, t, r)),
      "normal" === i && t in eQ && (i = eQ[t]),
      "" === n || n)
    ...
    _.each(["height", "width"], function (e, t) {
      _.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !eG.test(_.css(e, "display")) ||
    ...
    (_.cssHooks.marginLeft = eU(d.reliableMarginLeft, function (e, t) {
      if (t)
        return (
    ...
    _.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      ((_.cssHooks[e + t] = {
        ...
        "margin" !== e && (_.cssHooks[e + t].set = e6));
    }),
    _.fn.extend({
      css: function (e, t) {
        return K(
    ...
    (eJ.prototype = {
      ...
      cur: function () {
        ...
        return e && e.get ? e.get(this) : eJ.propHooks._default.get(this);
      },
      run: function (e) {
        var t,
          n = eJ.propHooks[this.prop];
        return (
          ...
          n && n.set ? n.set(this) : eJ.propHooks._default.set(this),
          this
        );
      },
    }),
    (eJ.prototype.init.prototype = eJ.prototype),
    (eJ.propHooks = {
      _default: {
        get: function (e) {
          var t;
    ...
    (eJ.propHooks.scrollTop = eJ.propHooks.scrollLeft =
      {
        set: function (e) {
    ...
    var r,
      ...
      u = function () {
        ...
        for (
          ...
          l.tweens[o].run(r);
        return (a.notifyWith(e, [l, r, n]), r < 1 && s)
          ? n
    ...
    for (
      !(function e(t, n) {
        ...
        for (r in t)
          if (
            ((o = n[(i = et(r))]),
            Array.isArray((s = t[r])) && ((o = s[1]), (s = t[r] = s[0])),
            r !== i && ((t[i] = s), delete t[r]),
            (a = _.cssHooks[i]) && ("expand" in a))
          )
            for (r in ((s = a.expand(s)), delete t[i], s))
              (r in t) || ((t[r] = s[r]), (n[r] = o));
          else n[i] = o;
  ...
  ((_.Animation = _.extend(ts, {
      ...
      function e(t, n, r) {
        ...
        n))
          if (((o = n[i]), tt.test(o))) {
            ...
            d[i] = (v && v[i]) || _.style(t, i);
          }
        if (!(!(l = !_.isEmptyObject(n)) && _.isEmptyObject(d)))
          for (i in (("width" in n || "height" in n) &&
            1 === t.nodeType &&
            ((r.overflow = [h.overflow, h.overflowX, h.overflowY]),
            null == (c = v && v.display) && (c = ei.get(t, "display")),
            "none" === (f = _.css(t, "display")) &&
              (c
                ? (f = c)
                : (em([t], !0),
                  (c = t.style.display || c),
          ...
          d))
            (l ||
              (v
                ...
                : (v = ei.access(t, "fxshow", { display: c })),
              s && (v.hidden = !g),
              g && em([t], !0),
              p.done(function () {
                for (i in (g || em([t]), ei.remove(t, "fxshow"), d))
                  _.style(t, i, d[i]);
              })),
              (l = to(g ? v[i] : 0, i, p)),
              i in v ||
    ...
    (_.fx.tick = function () {
      var e,
        t = 0,
        n = _.timers;
      for (eZ = Date.now(); t < n.length; t++)
        (e = n[t])() || n[t] !== e || n.splice(t--, 1);
      (n.length || _.fx.stop(), (eZ = void 0));
    }),
    ...
    (ta = v.createElement("input")),
    (tu = v.createElement("select").appendChild(v.createElement("option"))),
    (ta.type = "checkbox"),
    (d.checkOn = "" !== ta.value),
    (d.optSelected = tu.selected),
    ((ta = v.createElement("input")).value = "t"),
    (ta.type = "radio"),
    (d.radioValue = "t" === ta.value));
  var ta,
    tu,
    tl,
    tc = _.expr.attrHandle;
  (_.fn.extend({
    attr: function (e, t) {
      return K(this, _.attr, e, t, arguments.length > 1);
    },
    ...
    _.extend({
      attr: function (e, t, n) {
        var r,
          ...
          o = e.nodeType;
        if (3 !== o && 8 !== o && 2 !== o) {
          if (void 0 === e.getAttribute) return _.prop(e, t, n);
          if (
            ((1 === o && _.isXMLDoc(e)) ||
              (i =
                _.attrHooks[t.toLowerCase()] ||
                (_.expr.match.bool.test(t) ? tl : void 0)),
            void 0 !== n)
          ) {
            if (null === n) {
              _.removeAttr(e, t);
  ...
  (_.fn.extend({
    prop: function (e, t) {
      return K(this, _.prop, e, t, arguments.length > 1);
    },
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : tf.test(e.nodeName) || (tp.test(e.nodeName) && e.href)
                ? 0
                : -1;
          },
        },
    ...
    _.fn.extend({
      addClass: function (e) {
        ...
        return h(e)
          ? this.each(function (t) {
              _(this).addClass(e.call(this, t, th(this)));
            })
          : (t = tg(e)).length
            ? this.each(function () {
                if (
                  ((r = th(this)),
                  (n = 1 === this.nodeType && " " + td(r) + " "))
                ) {
                  for (o = 0; o < t.length; o++)
                    ((i = t[o]),
                      0 > n.indexOf(" " + i + " ") && (n += i + " "));
                  r !== (s = td(n)) && this.setAttribute("class", s);
                }
              })
            : this;
      },
      removeClass: function (e) {
        ...
        return h(e)
          ? this.each(function (t) {
              _(this).removeClass(e.call(this, t, th(this)));
            })
          : arguments.length
            ? (t = tg(e)).length
              ? this.each(function () {
      ...
      toggleClass: function (e, t) {
        ...
        return h(e)
          ? this.each(function (n) {
              _(this).toggleClass(e.call(this, n, th(this), t), t);
            })
          : "boolean" == typeof t && a
            ? t
              ? this.addClass(e)
            ...
            : ((n = tg(e)),
              this.each(function () {
                if (a)
                  for (i = 0, o = _(this); i < n.length; i++)
                    ((r = n[i]),
                      o.hasClass(r) ? o.removeClass(r) : o.addClass(r));
                else
                  (void 0 === e || "boolean" === s) &&
                    ((r = th(this)) && ei.set(this, "__className__", r),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        r || !1 === e
                          ? ""
                          : ei.get(this, "__className__") || "",
                      ));
              }));
      },
      hasClass: function (e) {
        var t,
          ...
          r = 0;
        for (t = " " + e + " "; (n = this[r++]); )
          if (1 === n.nodeType && (" " + td(th(n)) + " ").indexOf(t) > -1)
            return !0;
        return !1;
      },
    }));
  ...
  var tx = /^(?:focusinfocus|focusoutblur)$/,
    tb = function (e) {
      e.stopPropagation();
    };
  (_.extend(_.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        !(
          3 === r.nodeType ||
          8 === r.nodeType ||
          tx.test($ + _.event.triggered)
        ))
      ) {
        if (
          ($.indexOf(".") > -1 && (($ = (m = $.split(".")).shift()), m.sort()),
          (l = 0 > $.indexOf(":") && "on" + $),
          ((t = t[_.expando]
            ? t
            : new _.Event($, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = m.join(".")),
          ...
          if (!i && !p.noBubble && !g(r)) {
            for (
              u = p.delegateType || $, tx.test(u + $) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              (y.push(s), (a = s));
          ...
          return (
            ...
            !i &&
              ...
              ((a = r[l]) && (r[l] = null),
              (_.event.triggered = $),
              t.isPropagationStopped() && d.addEventListener($, tb),
              r[$](),
              t.isPropagationStopped() && d.removeEventListener($, tb),
  ...
  function tk(e, t, n, r) {
    ...
    else for (i in t) tk(e + "[" + i + "]", t[i], n, r);
  }
  ...
  ((tP.href = ty.href),
    _.extend({
      ...
      ajaxSetup: function (e, t) {
        return t ? t0(t0(e, _.ajaxSettings), t) : t0(_.ajaxSettings, e);
      },
      ajaxPrefilter: tO(tq),
      ajaxTransport: tO(tL),
      ajax: function (t, n) {
        ...
        if (
          ...
          try {
            ((u.href = d.url),
              (u.href = u.href),
              (d.crossDomain =
                tP.protocol + "//" + tP.host != u.protocol + "//" + u.host));
          } catch (C) {
            d.crossDomain = !0;
          }
        }
        ...
        d.hasContent
          ? d.data &&
            ...
            (d.data = d.data.replace(tS, "+"))
          : ((p = d.url.slice(i.length)),
            d.data &&
              (d.processData || "string" == typeof d.data) &&
              ((i += (tm.test(i) ? "&" : "?") + d.data), delete d.data),
            !1 === d.cache &&
              ((i = i.replace(tE, "$1")),
              (p = (tm.test(i) ? "&" : "?") + "_=" + t$.guid++ + p)),
            (d.url = i + p)),
        d.ifModified &&
          (_.lastModified[i] &&
        ...
        function S(t, n, s, u) {
          ...
          !l &&
            ...
            s &&
              (x = (function e(t, n, r) {
                for (
                  var i, o, s, a, u = t.contents, l = t.dataTypes;
                  "*" === l[0];
                )
                  (l.shift(),
                    void 0 === i &&
            ...
            !f &&
              _.inArray("script", d.dataTypes) > -1 &&
            ...
            (x = (function e(t, n, r, i) {
              ...
              for (s = f.shift(); s; )
                if (
                  (t.responseFields[s] && (r[t.responseFields[s]] = n),
  ...
  var tW = { 0: 200, 1223: 204 },
    tI = _.ajaxSettings.xhr();
  ((d.cors = !!tI && "withCredentials" in tI),
    (d.ajax = tI = !!tI),
    _.ajaxTransport(function (t) {
      var n, r;
      if (d.cors || (tI && !t.crossDomain))
        return {
          send: function (i, o) {
            var s,
              a = t.xhr();
  ...
  (_.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = t9.pop() || _.expando + "_" + t$.guid++;
      return ((this[e] = !0), e);
    },
  }),
    _.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (a || "jsonp" === t.dataTypes[0])
        return (
          ...
          a
            ? (t[a] = t[a].replace(tF, "$1" + i))
            : !1 !== t.jsonp &&
              (t.url += (tm.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
          ...
          r.always(function () {
            (void 0 === o ? _(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), t9.push(i)),
              s && h(o) && o(s[0]),
              (s = o = void 0));
          }),
          "script"
    ...
    (d.createHTMLDocument =
      (((tR = v.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (_.fn.load = function (e, t, n) {
      var r,
        ...
        a = e.indexOf(" ");
      return (
        a > -1 && ((r = td(e.slice(a))), (e = e.slice(0, a))),
        h(t)
          ? ((n = t), (t = void 0))
        ...
        if (this[0]) {
          ...
          if ("fixed" === _.css(r, "position")) t = r.getBoundingClientRect();
            ...
            e &&
              ...
              1 === e.nodeType &&
              ((i = _(e).offset()),
              (i.top += _.css(e, "borderTopWidth", !0)),
    ...
    _.each(["top", "left"], function (e, t) {
      _.cssHooks[t] = eU(d.pixelPosition, function (e, n) {
        if (n)
          return ((n = e2(e, t)), e1.test(n) ? _(e).position()[t] + "px" : n);
      });
    }),
